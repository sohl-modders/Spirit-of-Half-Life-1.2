...
protected:
	...
	// a text string describing how the status bar is to be drawn
...
public:
	...
	CShinySurface(float fScale, float fAlpha, float fMinX, float fMaxX, float fMinY, float fMaxY, float fZ,
	              char* szSprite);
	~CShinySurface();
