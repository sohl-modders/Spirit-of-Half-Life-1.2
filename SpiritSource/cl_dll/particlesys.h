...
public:
	...
	// General functions
	bool UpdateSystem(float frametime, /*vec3_t &right, vec3_t &up,*/ int messagenum);
	...
	// adds one of the free particles to the active list, and returns it for initialisation.
