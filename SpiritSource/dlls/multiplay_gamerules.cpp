	...
	if (g_fGameOver) // someone else quit the game already
	{
		...
		if (m_flIntermissionEndTime < gpGlobals->time)
		{
			if (m_iEndIntermissionButtonHit
				// check that someone has pressed a key, or the max intermission time is over
...
//=========================================================
//=========================================================
BOOL CHalfLifeMultiplay::ClientConnected(edict_t* pEntity, const char* pszName, const char* pszAddress,
...
void CHalfLifeMultiplay::InitHUD(CBasePlayer* pl)
{
	...
	UTIL_ClientPrintAll(HUD_PRINTNOTIFY, UTIL_VarArgs("%s has joined the game\n",
	                                                  (pl->pev->netname && STRING(pl->pev->netname)[0] != 0)
...
void CHalfLifeMultiplay::PlayerSpawn(CBasePlayer* pPlayer)
{
	...
	const int iAutoWepSwitch = pPlayer->m_iAutoWepSwitch;
