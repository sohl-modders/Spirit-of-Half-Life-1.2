...
class CTripmineGrenade : public CGrenade
{
	...
	// tracelines don't hit PEV->OWNER, which means a player couldn't detonate his own trip mine, so we store the owner here.
};
...
void CTripmine::PrimaryAttack(void)
{
	...
	PLAYBACK_EVENT_FULL(flags, m_pPlayer->edict(), m_usTripFire, 0.0, (float*)&g_vecZero, (float*)&g_vecZero, 0.0, 0.0,
	                    0, 0, 0, 0);
